    ...
    <div class="fundo flex-jc flex-ac">
        <div class="escurecer white" id="fundo">
            <div class="flex-jc pt-3 resultados flex-c">
                ...
                <div class="pt-1 w-100 flex-ac flex-c">
                    <div class="flex-c">
            ...
            <div class="flex-jc flex-ac flex-c w-100">
                ...
                <div class="flex-c w-100 flex-jc flex-ac">
                    ...
                    <span class="white pt-3 pb-2">* Caso não tenha informado os dados corretamente pode sofrer alguma alteração no sorteio.</span>
                </div>
            </div>
        </div>
    </div>
